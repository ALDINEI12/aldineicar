...
async function uploadFotoOficina(dataUrl, pasta) {
 ...
 // força JPEG quando possível (evita HEIC/preto em alguns celulares)
 ...
 // normaliza URL pública (sem cache-buster que atrapalha)
 try {
   if (typeof resolverUrlFoto === 'function') url = resolverUrlFoto(url) || url;
   else url = String(url).split('?')[0];
 } catch (eN) {}
 return url;
 } catch (e) {
