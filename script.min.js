...
async function gerarPixSimplesERegistrar() {
  var inputNome = document.getElementById('vendaNomeCliente') || document.getElementById('compraNomeCliente');
  var inputTel = document.getElementById('vendaTelCliente') || document.getElementById('compraTelCliente');
  var inputQtd = document.getElementById('vendaQtd') || document.getElementById('compraQtd');
  ...
  var idDono = (typeof idOficinaDaLojaAtual !== 'undefined' && idOficinaDaLojaAtual)
    ? idOficinaDaLojaAtual
    : (typeof usuarioAtualId !== 'undefined' ? usuarioAtualId : null);
  if (!idDono) {
