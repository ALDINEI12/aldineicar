...
function atualizarDashMobileUI(dados, ini, fim) {
  try {
    ...
    lista.forEach(function(h) {
      ...
      if (st.indexOf('pago') >= 0 || st === 'pago pix' || st === 'pago') pago++;
      else if (st.indexOf('conclu') >= 0 || st.indexOf('finaliz') >= 0) ok++;
      else if (st.indexOf('serviço') >= 0 || st.indexOf('servico') >= 0 || st.indexOf('andamento') >= 0 || st.indexOf('em serviço') >= 0) serv++;
      else if (st.indexOf('aguard') >= 0 || st.indexOf('pend') >= 0 || st === '' || st.indexOf('aberto') >= 0) pend++;
      else pend++;
    });
