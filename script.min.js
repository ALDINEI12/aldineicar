...
async function carregarProdutosVitrinePublica(idOficina) {
 ...
 <img src="${urlImagem}" style="width:100%;height:130px;object-fit:cover;border-radius:6px;background:#1f2937;" onerror="this.onerror=null;this.src=(typeof IMG_PLACEHOLDER_DARK!=='undefined'?IMG_PLACEHOLDER_DARK:'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22300%22%3E%3Crect fill=%22%231f2937%22 width=%22400%22 height=%22300%22/%3E%3C/svg%3E');">
...
function togglePainelBloqueio() {
  ...
  if (!painel) return;
  var aberto = painel.style.display === 'block' || painel.style.display === 'flex';
  if (aberto) {
...
function renderizarProdutosLoja() {
 ...
 const img = (typeof htmlImgProduto === 'function')
 ? htmlImgProduto(prod.imagem_url, false)
 : (prod.imagem_url
 ? '<img src="' + prod.imagem_url + '" alt="" style="width:100%;height:110px;object-fit:cover;border-radius:8px;margin-bottom:8px;background:#f1f5f9;" onerror="this.onerror=null;this.src=\'' + (typeof IMG_PLACEHOLDER_LOJA!=='undefined'?IMG_PLACEHOLDER_LOJA:'') + '\';">'
...
function urlFotoValida(u) {
  ...
  if (u.indexOf('data:image') === 0) return u.length > 40;
...
function htmlImgProduto(url, dark) {
  ...
  var src = urlFotoValida(url) ? url : ph;
  var bg = dark ? '#1f2937' : '#f1f5f9';
  return '<img src="' + src.replace(/"/g, '&quot;') + '" alt="" loading="lazy" decoding="async" style="width:100%;height:110px;object-fit:cover;border-radius:8px;margin-bottom:8px;background:' + bg + ';" onerror="this.onerror=null;this.src=\'' + ph + '\';">';
}

function htmlImgServicoPublico(url, nomeEsc) {
  var ph = IMG_PLACEHOLDER_DARK;
  if (!urlFotoValida(url)) {
    return '<div class="vt-servico-foto vt-servico-foto-empty"><img src="' + ph + '" alt="' + (nomeEsc||'') + '"></div>';
  }
  return '<div class="vt-servico-foto"><img src="' + String(url).replace(/"/g, '&quot;') + '" alt="' + (nomeEsc||'') + '" loading="lazy" onerror="this.onerror=null;this.src=\'' + ph + '\';"></div>';
}
...
function renderServicosVitrineAdmin() {
 ...
 var foto = s.foto || s.imagem || '';
 var img = (foto && typeof urlFotoValida === 'function' && urlFotoValida(foto))
 ? '<div class="servico-admin-thumb-wrap"><img class="servico-admin-thumb" src="'+foto+'" alt="" onerror="this.onerror=null;this.style.display=\'none\';var w=this.parentElement;if(w){w.classList.add(\'empty\');if(!w.querySelector(\'span\')){var t=document.createElement(\'span\');t.textContent=\'🔧\';w.appendChild(t);}}"></div>'
...
function renderServicosVitrinePublica(lista){
 ...
 var imgHtml = (typeof htmlImgServicoPublico === 'function')
 ? htmlImgServicoPublico(foto, nomeEsc)
 : (foto
 ? '<div class="vt-servico-foto"><img src="'+foto+'" alt="'+nomeEsc+'" loading="lazy"></div>'
 : '');
