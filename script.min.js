...
function aplicarTema(tema) {
  ...
  // Limpa estilos inline claros residual quando muda tema
  try {
    if (tema === 'dark') {
      document.querySelectorAll('input, textarea, select').forEach(function(el) {
        var st = (el.getAttribute('style') || '').toLowerCase();
        if (st.indexOf('background:#f') >= 0 || st.indexOf('background: #f') >= 0 || st.indexOf('background:#fff') >= 0) {
          el.style.setProperty('background', '#111827', 'important');
          el.style.setProperty('color', '#f1f5f9', 'important');
          el.style.setProperty('border-color', '#3b4a63', 'important');
        }
      });
      if (typeof forcarLegibilidadeEscuro === 'function') setTimeout(forcarLegibilidadeEscuro, 30);
      if (typeof corrigirCalendarioEscuro === 'function') setTimeout(corrigirCalendarioEscuro, 40);
      if (typeof corrigirVitrineEscuro === 'function') setTimeout(corrigirVitrineEscuro, 40);
      if (typeof corrigirPainelResumoEscuro === 'function') setTimeout(corrigirPainelResumoEscuro, 40);
      if (typeof corrigirBotoesTemaEscuro === 'function') setTimeout(corrigirBotoesTemaEscuro, 40);
    } else {
      document.querySelectorAll('input, textarea, select').forEach(function(el) {
...
function corrigirPainelResumoEscuro() {
  try {
    if (document.documentElement.getAttribute('data-theme') !== 'dark') return;
    var resumo = document.querySelector('.resumo');
    if (!resumo) return;
    resumo.style.setProperty('background', '#111827', 'important');
    resumo.style.setProperty('color', '#f1f5f9', 'important');
    resumo.querySelectorAll('.resumo-total-item, .resumo-grupo, .resumo-grupo-body, .resumo-grupo > summary').forEach(function(el) {
      el.style.setProperty('background', '#1e293b', 'important');
      el.style.setProperty('color', '#f1f5f9', 'important');
      el.style.setProperty('border-color', '#334155', 'important');
    });
    resumo.querySelectorAll('label, span, p, small, h2, strong').forEach(function(el) {
      var c = window.getComputedStyle(el).color || '';
      var m = c.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);
      if (m && +m[1] < 80 && +m[2] < 80 && +m[3] < 80) {
        el.style.setProperty('color', '#e2e8f0', 'important');
      }
    });
    resumo.querySelectorAll('input, select, textarea').forEach(function(el) {
    ...
    // agenda nomes
    document.querySelectorAll('.ag-nome, .cal-nome-evt, .cal-num').forEach(function(el) {
      el.style.setProperty('color', '#f8fafc', 'important');
    });
    document.querySelectorAll('#cal-grid .cal-cell, button.cal-cell').forEach(function(el) {
      el.style.setProperty('background', '#151c2c', 'important');
      el.style.setProperty('color', '#f1f5f9', 'important');
      el.style.setProperty('border-color', '#334155', 'important');
    });
    document.querySelectorAll('.ag-item-main, .ag-item').forEach(function(el) {
      el.style.setProperty('background', '#151c2c', 'important');
      el.style.setProperty('color', '#f1f5f9', 'important');
      el.style.setProperty('border-color', '#334155', 'important');
    });
    // loja categorias
    document.querySelectorAll('#botoesCategoriasLoja button, .cat-loja-chip').forEach(function(el) {
      var isActive = el.classList.contains('active') || el.classList.contains('is-active');
      if (isActive) {
...
window.corrigirPainelResumoEscuro = corrigirPainelResumoEscuro;

function corrigirBotoesTemaEscuro() {
  try {
    if (document.documentElement.getAttribute('data-theme') !== 'dark') return;
    if (typeof corrigirPainelResumoEscuro === 'function') corrigirPainelResumoEscuro();
    if (typeof corrigirVitrineEscuro === 'function') corrigirVitrineEscuro();
...
function corrigirCalendarioEscuro() {
  try {
    if (document.documentElement.getAttribute('data-theme') !== 'dark') return;
    var cells = document.querySelectorAll('#cal-grid .cal-cell, #cal-grid button.cal-cell');
    cells.forEach(function(el) {
      ...
      el.style.setProperty('color', '#f8fafc', 'important');
      el.style.setProperty('border-color', '#475569', 'important');
      if (el.classList.contains('cal-cell-hoje')) {
        el.style.setProperty('background', '#172554', 'important');
        el.style.setProperty('border-color', '#3b82f6', 'important');
      }
      if (el.classList.contains('cal-cell-sel')) {
        el.style.setProperty('background', '#1e293b', 'important');
        el.style.setProperty('border-color', '#f87171', 'important');
      }
    });
    document.querySelectorAll('#cal-grid .cal-num, #cal-grid .cal-nome-evt').forEach(function(el) {
      el.style.setProperty('color', '#f8fafc', 'important');
    });
    document.querySelectorAll('#cal-grid .cal-badge-pend').forEach(function(el) {
      el.style.setProperty('background', '#854d0e', 'important');
      el.style.setProperty('color', '#fef3c7', 'important');
    });
    document.querySelectorAll('#cal-grid .cal-badge-conc').forEach(function(el) {
      el.style.setProperty('background', '#065f46', 'important');
      el.style.setProperty('color', '#a7f3d0', 'important');
    });
    document.querySelectorAll('#cal-grid .cal-badge-canc').forEach(function(el) {
      el.style.setProperty('background', '#9f1239', 'important');
      el.style.setProperty('color', '#fecdd3', 'important');
    });
    var wrap = document.querySelector('#aba-agenda .cal-wrap');
    if (wrap) {
      wrap.style.setProperty('background', '#0f172a', 'important');
      wrap.style.setProperty('border-color', '#334155', 'important');
    }
  } catch (e) {}
}
window.corrigirCalendarioEscuro = corrigirCalendarioEscuro;

(function() {
  var tries = 0;
  function bind() {
    if (typeof window.renderAgenda !== 'function') {
      if (tries++ < 40) setTimeout(bind, 200);
      return;
    }
    var orig = window.renderAgenda;
    if (orig.__darkPatched) return;
    window.renderAgenda = function() {
      var r = orig.apply(this, arguments);
      setTimeout(corrigirCalendarioEscuro, 30);
      return r;
    };
    window.renderAgenda.__darkPatched = true;
  }
  bind();
})();

function corrigirVitrineEscuro() {
  try {
    if (document.documentElement.getAttribute('data-theme') !== 'dark') return;
    var root = document.getElementById('aba-vitrine');
    if (!root) return;
    ...
    root.querySelectorAll('.grupo-card, .grupo-card-body, .grupo-card-head, .grupo-card-summary, summary, .servico-admin-item, .loja-link-box').forEach(function(el) {
      el.style.setProperty('background', '#151c2c', 'important');
      el.style.setProperty('color', '#f1f5f9', 'important');
      el.style.setProperty('border-color', '#334155', 'important');
    });
    root.querySelectorAll('label, p, span, small, h2, h3, strong').forEach(function(el) {
      var cs = window.getComputedStyle(el);
      var bg = cs.backgroundColor || '';
      // don't touch badges with intentional color if needed
      el.style.setProperty('color', '#e2e8f0', 'important');
    });
    root.querySelectorAll('.btn-loja-sec, .btn-loja-toggle, .btn-page-action, .btn-cat-add').forEach(function(el) {
      el.style.setProperty('background', '#334155', 'important');
      el.style.setProperty('color', '#f8fafc', 'important');
    });
    root.querySelectorAll('.btn-loja-prim').forEach(function(el) {
      el.style.setProperty('background', '#dc2626', 'important');
      el.style.setProperty('color', '#fff', 'important');
    });
  } catch (e) {}
}
window.corrigirVitrineEscuro = corrigirVitrineEscuro;
(function() {
  var orig = window.mostrarAba;
  if (typeof orig !== 'function') return;
  window.mostrarAba = function(nome) {
    var r = orig.apply(this, arguments);
    if (nome === 'vitrine' && document.documentElement.getAttribute('data-theme') === 'dark') {
      setTimeout(corrigirVitrineEscuro, 50);
      setTimeout(corrigirVitrineEscuro, 300);
    }
    return r;
  };
})();

function forcarLegibilidadeEscuro() {
  if (document.documentElement.getAttribute('data-theme') !== 'dark') return;
  try {
    // texto quase preto -> branco
    document.querySelectorAll('h1,h2,h3,h4,label,p,span,strong,b,small,td,th,li,div,a,button').forEach(function(el) {
      if (!el || !el.style) return;
      // skip bottom nav icons handled by class
      var cs = window.getComputedStyle(el);
      if (!cs) return;
      var c = cs.color || '';
      var m = c.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);
      if (m) {
        ...
        } else if (r < 140 && g < 140 && b < 150 && r > 80) {
          el.style.setProperty('color', '#e2e8f0', 'important');
        }
      }
      var bg = cs.backgroundColor || '';
      var mb = bg.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);
      if (mb) {
        var r2 = +mb[1], g2 = +mb[2], b2 = +mb[3];
        if (r2 > 230 && g2 > 230 && b2 > 230) {
          el.style.setProperty('background', '#1a2234', 'important');
          el.style.setProperty('background-color', '#1a2234', 'important');
        }
      }
    });
    // calendar force
    document.querySelectorAll('#cal-grid .cal-cell, #cal-grid button.cal-cell').forEach(function(el) {
      el.style.setProperty('background', '#1a2234', 'important');
      el.style.setProperty('color', '#ffffff', 'important');
      el.style.setProperty('border-color', '#2d3a4f', 'important');
    });
    document.querySelectorAll('#cal-grid .cal-num, #cal-grid .cal-nome-evt, .ag-nome').forEach(function(el) {
      el.style.setProperty('color', el.classList.contains('cal-nome-evt') ? '#fde68a' : '#ffffff', 'important');
    });
  } catch (e) {}
}
window.forcarLegibilidadeEscuro = forcarLegibilidadeEscuro;

(function() {
  var o = window.mostrarAba;
  if (typeof o !== 'function' || o.__legibPatched) return;
  window.mostrarAba = function(nome) {
    var r = o.apply(this, arguments);
    if (document.documentElement.getAttribute('data-theme') === 'dark') {
      setTimeout(forcarLegibilidadeEscuro, 60);
      setTimeout(forcarLegibilidadeEscuro, 250);
    }
    return r;
  };
  window.mostrarAba.__legibPatched = true;
})();
