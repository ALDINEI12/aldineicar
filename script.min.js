  ...
  window.carregarProdutosVitrinePublica = async function(idOficina) {
    ...
    try {
      ...
      if (oficina.vitrine_aberta === false) {
        containerVitrine.innerHTML = '<div style="grid-column:1/-1;text-align:center;padding:48px 20px;color:#a1a1aa;"><div style="font-size:36px;margin-bottom:10px;">🔒</div><p style="font-size:16px;font-weight:700;color:#fff;margin:0 0 6px;">Vitrine temporariamente fechada</p></div>';
        return;
      }
