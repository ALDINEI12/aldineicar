...
async function carregarPainelAdmin() {
  ...
  try {
    ...
    if (!lista.length) {
      box.innerHTML = '<p style="padding:12px;color:#64748b;">Nenhuma oficina cadastrada ainda.</p>';
      return;
    }
    box.innerHTML = '<p style="font-size:13px;color:#64748b;margin-bottom:10px;">' + lista.length + ' oficina(s)</p>' + lista.map(function(o) {
      return '<div class="admin-oficina-card">'
        + '<strong>' + (o.nome || '—') + '</strong>'
        + '<div class="admin-oficina-meta">' + (o.email || '') + '</div>'
        + '<div class="admin-oficina-meta">' + (o.fone || '') + (o.profissao ? ' · ' + o.profissao : '') + '</div>'
        + '<div class="admin-oficina-meta">Histórico: ' + (o.qtd_historico || 0) + ' · Clientes: ' + (o.qtd_clientes || 0) + '</div>'
